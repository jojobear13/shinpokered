...
WigglytuffEvosMoves_Alt:	;joenote - modified for level-up moves
; Evolutions
	db 0
; Learnset
	db 9, POUND
...
KakunaEvosMoves_Alt:	;joenote - gave harden
; Evolutions
...
MetapodEvosMoves_Alt: ;joenote - gave harden
; Evolutions
...
ClefableEvosMoves_Alt:	;joenote - modified to gain level up moves
; Evolutions
	db 0
; Learnset
	db 13, SING
